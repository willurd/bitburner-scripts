...
describe('stockMarketProfit', () => {
  ...
  contract(
    'contract-478039',
    '200,126,166,161,127,110,151,92,113,153,45,154,178,115,195,147,41,157,64,174,162,156,44,182,123,174,197,187,142,27,160,81',
    306,
    2,
  );
  ...
  contract(
    'contract-778489',
    '172,90,56,66,121,81,180,72,149,179,184,16,93,27,129,86,169,157,79,187,53,91,36,164,116,78,76,145,129,163,31',
    171,
    1,
  );

  contract('contract-790374', '50,55,150,182,167,192,185,20,123,97,160', 142, 1);
});
